...
class HeadingRule(Rule):
	"""
	A heading is a sigle line that is at most 70 characters and 
...
class TitleRule(HeadingRule):
	"""
	The title is the first block in the document, provided that ite is
	a heading.
	"""
...
class ListRule(ListItemRule):
	"""
	A list begins between a block that is not a list item adn a 
